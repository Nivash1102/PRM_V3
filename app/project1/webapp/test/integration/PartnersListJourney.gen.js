...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("PartnersListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onThePartnersListGenerated.iSeeThisPage();
        });
        ...
        //     When.onThePartnersListGenerated.onFilterBar().iChangeSearchField("Search Term");
